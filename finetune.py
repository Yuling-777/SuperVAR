...
vae_ckpt, var_ckpt = './vae_ch160v4096z32.pth', f'./var_d36.pth'
...
# === Usage Example ===
dataset = Flickr2KSRDataset(root_dir='./data/kagglehub/datasets/daehoyang/flickr2k/versions/1/Flickr2K', scale=2, patch_size=512, stride=256)
